...
const $ = ({
  ...
  name: string;
  className?: string;
}) => <img src={svg} className={cn(className)} alt={name} />;

export const Icons = {
  React: ({ className }: { className: string }) =>
    $({ svg: react_svg, name: "react", className }),
  Python: ({ className }: { className: string }) =>
    $({ svg: python_image, name: "python", className }),
  Terminal: ({ className }: { className: string }) =>
    $({ svg: terminal_svg, name: "terminal", className }),
  Docker: ({ className }: { className: string }) =>
    $({ svg: docker_svg, name: "docker", className }),
  Folder: ({ className }: { className: string }) =>
    $({ svg: folder_svg, name: "folder", className }),
  Vite: ({ className }: { className: string }) =>
    $({ svg: vite_svg, name: "vite", className }),
  VSCode: ({ className }: { className: string }) =>
    $({ svg: vscode_svg, name: "vscode", className }),
  Menu: ({ className }: { className: string }) =>
    $({ svg: menu_svg, name: "menu", className }),
  Control_Center: ({ className }: { className: string }) =>
    $({ svg: control_center_svg, name: "control_center", className }),
  Upload: ({ className }: { className: string }) =>
    $({ svg: upload_svg, name: "upload", className }),
  PDF: ({ className }: { className: string }) =>
    $({ svg: pdf_svg, name: "pdf", className }),
  Image: ({ className }: { className: string }) =>
    $({ svg: image_svg, name: "image", className }),
  File: ({ className }: { className: string }) =>
    $({ svg: file_svg, name: "file", className }),
  Logo: ({ className }: { className: string }) =>
    $({ svg: logo_svg, name: "logo", className }),
  Right_Arrow: ({ className }: { className: string }) =>
    $({ svg: right_arrow_svg, name: "right_arrow", className }),
  Trash: ({ className }: { className: string }) =>
    $({ svg: trash_svg, name: "trash", className }),
  Cross: ({ className }: { className: string }) =>
    $({ svg: cross_svg, name: "cross", className }),
  Left_Arrow: ({ className }: { className: string }) =>
    $({ svg: left_arrow, name: "left_arrow", className }),
  Right_Arrow2: ({ className }: { className: string }) =>
    $({ svg: right_arrow2_svg, name: "right_arrow", className }),
  Grid4: ({ className }: { className: string }) =>
    $({ svg: grid4_svg, name: "grid-4", className }),
  Grid2: ({ className }: { className: string }) =>
    $({ svg: grid2_svg, name: "grid-2", className }),
  Cloud: ({ className }: { className: string }) =>
    $({ svg: cloud_svg, name: "cloud", className }),
  Folder2: ({ className }: { className: string }) =>
    $({ svg: folder2_svg, name: "folder2", className }),
  Home: ({ className }: { className: string }) =>
    $({ svg: home_svg, name: "home", className }),
  Select_Multiple: ({ className }: { className: string }) =>
    $({ svg: select_multiple_svg, name: "select_multiple", className }),
  Folder_Add: ({ className }: { className: string }) =>
    $({ svg: folder_add_svg, name: "folder_add", className }),
  Eye: ({ className }: { className: string }) =>
    $({ svg: eye_svg, name: "eye", className }),
  Closed_Eye: ({ className }: { className: string }) =>
    $({ svg: closed_eye_svg, name: "closed_eye", className }),
  Loader: ({ className }: { className: string }) =>
    $({ svg: loader_svg, name: "loader", className }),
  Spinner: ({ className }: { className?: string }) =>
    $({ svg: spinner_svg, name: "spinner", className }),
  User: ({ className }: { className: string }) =>
    $({ svg: user_svg, name: "user", className }),
  Full_Screen: ({ className }: { className: string }) =>
    $({ svg: full_screen_svg, name: "full_screen", className }),
  Full_Screen_Exit: ({ className }: { className: string }) =>
    $({ svg: full_screen_exit_svg, name: "full_screen_exit", className }),
  Settings: ({ className }: { className: string }) =>
    $({ svg: settings_svg, name: "settings", className }),
  Lock: ({ className }: { className: string }) =>
    $({ svg: lock_svg, name: "lock", className }),
  Logout: ({ className }: { className: string }) =>
    $({ svg: logout_svg, name: "logout", className }),
  Trash2: ({ className }: { className: string }) =>
    $({ svg: trash_svg2, name: "trash", className }),
  Settings2: ({ className }: { className: string }) =>
    $({ svg: settings2_svg, name: "settings", className }),
  Paint: ({ className }: { className: string }) =>
    $({ svg: paint_svg, name: "paint", className }),
  Pie: ({ className }: { className: string }) =>
    $({ svg: pie_svg, name: "pie", className }),
  Account: ({ className }: { className: string }) =>
    $({ svg: account_svg, name: "account", className }),
  Dollar: ({ className }: { className: string }) =>
    $({ svg: dollar_svg, name: "dollar", className }),
  Exclamation: ({ className }: { className: string }) =>
    $({ svg: exclamation_svg, name: "exclamation", className }),
  Right_Arrow_White: ({ className }: { className: string }) =>
    $({ svg: right_arrow_white, name: "right_arrow_white", className }),
  Move: ({ className }: { className: string }) =>
    $({ svg: move_svg, name: "move", className }),
  Copy: ({ className }: { className: string }) =>
    $({ svg: copy_svg, name: "copy", className }),
  Download: ({ className }: { className: string }) =>
    $({ svg: download_svg, name: "download", className }),
  Trash3: ({ className }: { className: string }) =>
    $({ svg: trash_svg3, name: "trash", className }),
  Rename: ({ className }: { className: string }) =>
    $({ svg: rename_svg, name: "rename", className }),
  Paste: ({ className }: { className: string }) =>
    $({ svg: paste_svg, name: "paste", className }),
  Zoom_In: ({ className }: { className: string }) =>
    $({ svg: zoom_in_svg, name: "zoom_in", className }),
  Zoom_Out: ({ className }: { className: string }) =>
    $({ svg: zoom_out_svg, name: "zoom_out", className }),
  Reset: ({ className }: { className: string }) =>
    $({ svg: reset_svg, name: "reset", className }),
  Rotate: ({ className }: { className: string }) =>
    $({ svg: rotate_svg, name: "rotate", className }),
  Zap: ({ className }: { className: string }) =>
    $({ svg: zap_svg, name: "zap", className }),
  Music: ({ className }: { className: string }) =>
    $({ svg: music_svg, name: "music", className }),
  Video: ({ className }: { className: string }) =>
    $({ svg: video_svg, name: "video", className }),
  Google_Logo_White: ({ className }: { className: string }) =>
    $({ svg: google_logo_white_svg, name: "google_logo_white", className }),
  Upload1: ({ className }: { className: string }) =>
    $({ svg: upload1_svg, name: "upload1", className }),
  Notepad: ({ className }: { className: string }) =>
    $({ svg: notepad_svg, name: "notepad", className }),
  Note: ({ className }: { className: string }) =>
    $({ svg: note_svg, name: "note", className }),
  Documents: ({ className }: { className: string }) =>
    $({ svg: documents_svg, name: "documents", className }),
  Document: ({ className }: { className: string }) =>
    $({ svg: document_svg, name: "document", className }),
  Play_Square: ({ className }: { className: string }) =>
    $({ svg: play_square_svg, name: "play_square", className }),
  Play_Button: ({ className }: { className: string }) =>
    $({ svg: play_button_svg, name: "play_button", className }),
  Camera: ({ className }: { className: string }) =>
    $({ svg: camera_svg, name: "camera", className }),
};
