...
export function showToast(
  ...
  const toastElements: {
    ...
    success: (toastId) => (
      <SuccessToast message={message} onClose={onClose} toastId={toastId} />
    ),
    error: (toastId) => (
      <ErrorToast message={message} onClose={onClose} toastId={toastId} />
    ),
    warning: (toastId) => (
      <WarningToast message={message} onClose={onClose} toastId={toastId} />
    ),
  };
  ...
  return (
    ...
    >
      ...
      <p
        ...
        className="m-0 w-full truncate text-left"
      >
        {fileName}
      </p>
      {status === "loading" && (
