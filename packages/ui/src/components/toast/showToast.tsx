...
export const SuccessToast = ({ message, onClose, toastId }: IToast) => (
    <button
        ...
        <span className="mt-0.5">
            <Icons.Cross className="h-4 w-4 hover:cursor-pointer" />
        </span>
    </button>
);
...
export const ErrorToast = ({ message, onClose, toastId }: IToast) => (
    <button
        ...
        <span className="mt-0.5">
            <Icons.Cross className="text-semantic-error h-4 w-4 hover:cursor-pointer" />
        </span>
    </button>
);
...
export const WarningToast = ({ message, onClose, toastId }: IToast) => (
    <button
        className={classNames(
            " mb-2 flex bg-yellow-400/80 h-auto space-x-2 rounded-md border px-3 py-2.5 text-sm font-semibold rtl:space-x-reverse md:max-w-sm"
        )}
        onClick={() => onClose(toastId)}>
        <span className="mt-0.5">
        ...
        <span className="mt-0.5">
            <Icons.Cross className="text-semantic-attention h-4 w-4 hover:cursor-pointer" />
        </span>
    </button>
);
