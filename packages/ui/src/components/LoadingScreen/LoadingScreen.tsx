...
const LoadingScreen: React.FC<LoadingScreenProps> = ({
  ...
  return (
    <motion.div
      className={cn(
        "fixed transition-all inset-0 flex flex-col items-center justify-center bg-[#1A1F2C] text-white overflow-hidden z-50",
        " bg-black/10",
      )}
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center gap-8 px-6">
        ...
        <div className="flex flex-col items-center gap-3 mt-4">
          <div className="text-xl font-medium tracking-wide text-white/90">
            {loadingText}
          </div>
