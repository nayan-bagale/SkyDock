...
const ForgotPassword: FC<SigninProps> = () => {
  ...
  const resendOtp = async () => {
    try {
      ...
      showToast("OTP resend to your email", "success");
    } catch (e: any) {
    ...
    switch (step) {
      ...
      case 2: {
        ...
        if (!confirmPasswordInfo.valid) {
          dispatch({
            type: ActionTypes.SET_CONFIRM_PASSWORD_ERROR,
            payload: confirmPasswordInfo.message,
          });
          return;
        }
      ...
      <Form className="mt-4" onSubmit={handleSubmit}>
        ...
        {step === 2 && (
          <NewPassword_Component
            ...
            confirmPasswordError={state.confirmPassword.error}
          />
        )}
...
const NewPassword_Component = memo(
  ({
