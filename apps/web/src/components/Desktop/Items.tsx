...
import { deleteItem, openExplorer, renameItem, setCurrentFolderAndCurrentTab } from "@/redux/features/explorer/explorerSlice";
    ...
    ({ item, handleDragStart, handleDrop }) => {
        ...
        return (
            <div className="relative h-fit">
                ...
                />
                {contextMenu && (
                    <ContextMenu ref={contextMenuRef} className={'left-4'}>
