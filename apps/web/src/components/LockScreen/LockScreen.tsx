import {
  attemptUnlock,
  unlockScreen,
} from "@/redux/features/lockScreen/lockScreenSlice";
...
const LockScreen = () => {
  ...
  const { pin, attempts, maxAttempts, lockTime } = useAppSelector(
    ...
    >
      <div className="flex flex-col justify-center items-center gap-8 text-white">
        ...
        <Form onSubmit={handleUnlock}>
          ...
          <Button
            size={"medium"}
            className="flex justify-center items-center bg-blue-600 hover:bg-blue-700 my-2 w-full text-white"
            intent={"secondary"}
            type="submit"
          >
            Unlock
