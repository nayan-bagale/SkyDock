...
const ChatBox = ({ isOpen, onClose }: ChatBoxProps) => {
    ...
    const bgColor = useAppSelector(
        (state) => state.settings.apperance.theme?.color
    );
    ...
    return (
        ...
        >
            ...
            {/* Chat Container */}
            <div
                className={`relative flex flex-col w-full max-w-2xl h-[700px] mx-4 bg-white/10 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 transition-all duration-300 transform ${isVisible && !isClosing
            ...
            >
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-4 ">
                    ...
                    {isTyping && (
                        <div className="flex items-start gap-3 animate-fade-in">
                            ...
                            <div className={cn("w-8 h-8 bg-gradient-to-r rounded-full flex items-center justify-center flex-shrink-0 shadow-lg", bgColor)}>
                ...
                <div className="p-4 border-t border-white/10">
                    <p className="text-sm text-white/60 mb-2">Remaining message </p>
                    ...
                    <p className="text-xs text-white/50 mt-2 text-center">
                        Press{" "}
                        <kbd className="px-1.5 py-0.5 text-xs font-semibold text-white/80 bg-white/10 border border-white/20 rounded backdrop-blur-sm">
                            Ctrl
                        </kbd>{" "}
                        +{" "}
                        <kbd className="px-1.5 py-0.5 text-xs font-semibold text-white/80 bg-white/10 border border-white/20 rounded backdrop-blur-sm">
