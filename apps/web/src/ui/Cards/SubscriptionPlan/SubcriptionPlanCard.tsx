...
export default function SubscriptionPlanCard({
  ...
  return (
    <div className="relative">
      ...
      <div
        className={`rounded-xl bg-white  shadow w-[16rem]  border-2 transition-all duration-200 ${
          current
      ...
      >
        <div className="flex flex-col p-6 space-y-1 pb-2">
          ...
          {!popular && !current && <div className=" py-3"></div>}
          <div className=" leading-none tracking-tight text-2xl font-bold">
            {name}
          </div>
        ...
        <div className="flex items-center p-2 pt-0">
          {current ? (
            <Button
              disabled
              className="w-full bg-green-500 hover:bg-green-500 py-1.5"
              intent="action"
            >
              Current Plan
            </Button>
