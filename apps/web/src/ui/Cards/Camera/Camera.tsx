        ...
        return (
            <motion.div
                className={cn("text-black shadow absolute aspect-video min-w-[35rem] max-w-[85vw] min-h-[20rem] max-h-[88vh] backdrop-blur  overflow-hidden",
                    ...
                    className,
                    isMaximized ? "max-w-full min-w-[100vw] min-h-[88vh] top-0 rounded-none resize-none" : "w-[35rem] h-[22rem] resize rounded-xl",
                )}
                ref={ref}
            ...
            >
                ...
                <div className="w-full relative bg-black/80 h-full">
                    {children}
                </div>
            </motion.div>
        );
