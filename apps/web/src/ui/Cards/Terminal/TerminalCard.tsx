...
export const TerminalCard = forwardRef<HTMLDivElement, TerminalCardProps>(
  (
    { style, onMouseDown, onMouseDownCard, Action, isFocused, className },
    ref,
  ) => {
    return (
      // <AnimatePresence>
      ...
      >
        <div
          className=" flex items-center justify-between px-2 py-1.5 text-sm w-full bg-black/80 rounded"
